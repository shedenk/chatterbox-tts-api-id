...
ENDPOINT_ALIASES: Dict[str, List[str]] = {
    ...
    "/audio/speech/long": ["/v1/audio/speech/long", "/v1/tts/long-text", "/tts/long-text"],
    ...
    "/audio/speech/long/{job_id}": ["/v1/audio/speech/long/{job_id}", "/v1/tts/long-text/status/{job_id}", "/tts/long-text/status/{job_id}"],
